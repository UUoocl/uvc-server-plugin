...
//
  ...
  - (id) jsonObjectFromBuffer:(void*)buffer
  {
    ...
    NSNumber* (^getNumber)(void*, UVCTypeComponentType) = ^NSNumber*(void* buf, UVCTypeComponentType type) {
        switch (type) {
            case kUVCTypeComponentTypeBoolean: return [NSNumber numberWithBool:(*(UInt8*)buf ? YES : NO)];
            case kUVCTypeComponentTypeSInt8: return [NSNumber numberWithChar:*(SInt8*)buf];
            case kUVCTypeComponentTypeUInt8: 
            case kUVCTypeComponentTypeBitmap8: return [NSNumber numberWithUnsignedChar:*(UInt8*)buf];
            case kUVCTypeComponentTypeSInt16: return [NSNumber numberWithShort:*(SInt16*)buf];
            case kUVCTypeComponentTypeUInt16:
            case kUVCTypeComponentTypeBitmap16: return [NSNumber numberWithUnsignedShort:*(UInt16*)buf];
            case kUVCTypeComponentTypeSInt32: return [NSNumber numberWithInt:*(SInt32*)buf];
            case kUVCTypeComponentTypeUInt32:
            case kUVCTypeComponentTypeBitmap32: return [NSNumber numberWithUnsignedInt:*(UInt32*)buf];
            case kUVCTypeComponentTypeSInt64: return [NSNumber numberWithLongLong:*(SInt64*)buf];
            case kUVCTypeComponentTypeUInt64:
            case kUVCTypeComponentTypeBitmap64: return [NSNumber numberWithUnsignedLongLong:*(UInt64*)buf];
    ...
    while ( FIELD_PTR < FIELD_MAX ) {
        [dict setObject:getNumber(buffer, FIELD_PTR->fieldType) forKey:(FIELD_PTR->fieldName ? FIELD_PTR->fieldName : @"value")];
...
//
  ...
  - (NSDictionary*) typeSummaryDictionary
  {
    ...
    while ( FIELD_PTR < FIELD_MAX ) {
        ...
        [dict setObject:(typeStr ? [NSString stringWithUTF8String:typeStr] : @"unknown") forKey:(FIELD_PTR->fieldName ? FIELD_PTR->fieldName : @"value")];
        FIELD_PTR++;
    }
    return dict;
  }
