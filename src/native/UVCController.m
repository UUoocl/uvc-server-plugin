...
uvc_control_t UVCControllerControls[] = {
    ...
    UVC_CONTROL_INIT(UVC_INPUT_TERMINAL_ID, CT_PANTILT_RELATIVE_CONTROL,
                     "{S1 pan-relative; U1 pan-speed; S1 tilt-relative; U1 tilt-speed}"),
    ...
    UVC_CONTROL_INIT(
        UVC_INPUT_TERMINAL_ID, CT_WINDOW_CONTROL,
        "{U2 window-top; U2 window-left; U2 window-bottom; U2 window-right; U2 num-steps; M2 num-steps-units}"),
    UVC_CONTROL_INIT(UVC_INPUT_TERMINAL_ID, CT_REGION_OF_INTEREST_CONTROL,
                     "{U2 roi-top; U2 roi-left; U2 roi-bottom; U2 roi-right; M2 auto-controls}"),
    //
...
+ (NSDictionary *)controlMapping
{
    ...
    if (!sharedControlMapping) {
        sharedControlMapping = [[NSDictionary alloc]
            initWithObjectsAndKeys:[NSNumber numberWithInt:0], UVCTerminalControlScanningMode,
                                   ...
                                   [NSNumber numberWithInt:7], UVCTerminalControlAutoFocus, [NSNumber numberWithInt:8],
                                   UVCTerminalControlIrisAbsolute, [NSNumber numberWithInt:9],
                                   UVCTerminalControlIrisRelative, [NSNumber numberWithInt:10],
                                   UVCTerminalControlZoomAbsolute, [NSNumber numberWithInt:11],
                                   UVCTerminalControlZoomRelative, [NSNumber numberWithInt:12],
                                   UVCTerminalControlPanTiltAbsolute, [NSNumber numberWithInt:13],
                                   UVCTerminalControlPanTiltRelative, [NSNumber numberWithInt:14],
                                   UVCTerminalControlRollAbsolute, [NSNumber numberWithInt:15],
                                   UVCTerminalControlRollRelative, [NSNumber numberWithInt:16],
                                   UVCTerminalControlPrivacy, [NSNumber numberWithInt:17],
                                   UVCTerminalControlFocusSimple, [NSNumber numberWithInt:18], UVCTerminalControlWindow,
                                   ...
                                   [NSNumber numberWithInt:38], UVCProcessingUnitControlAutoContrast, nil];
    }
...
+ (NSDictionary *)terminalControlEnableMapping
{
    ...
    if (!sharedTerminalControlEnableMapping) {
        sharedTerminalControlEnableMapping = [[NSDictionary alloc]
            initWithObjectsAndKeys:
                ...
                [NSNumber numberWithInt:kUVCTerminalControlEnableAutoExposurePriority],
                UVCTerminalControlAutoExposurePriority,
                [NSNumber numberWithInt:kUVCTerminalControlEnableExposureTimeAbsolute],
                UVCTerminalControlExposureTimeAbsolute,
                [NSNumber numberWithInt:kUVCTerminalControlEnableExposureTimeRelative],
                UVCTerminalControlExposureTimeRelative, [NSNumber numberWithInt:kUVCTerminalControlEnableFocusAbsolute],
                UVCTerminalControlFocusAbsolute, [NSNumber numberWithInt:kUVCTerminalControlEnableFocusRelative],
                UVCTerminalControlFocusRelative, [NSNumber numberWithInt:kUVCTerminalControlEnableIrisAbsolute],
                UVCTerminalControlIrisAbsolute, [NSNumber numberWithInt:kUVCTerminalControlEnableIrisRelative],
                UVCTerminalControlIrisRelative, [NSNumber numberWithInt:kUVCTerminalControlEnableZoomAbsolute],
                UVCTerminalControlZoomAbsolute, [NSNumber numberWithInt:kUVCTerminalControlEnableZoomRelative],
                UVCTerminalControlZoomRelative, [NSNumber numberWithInt:kUVCTerminalControlEnablePanTiltAbsolute],
                UVCTerminalControlPanTiltAbsolute, [NSNumber numberWithInt:kUVCTerminalControlEnablePanTiltRelative],
                UVCTerminalControlPanTiltRelative, [NSNumber numberWithInt:kUVCTerminalControlEnableRollAbsolute],
                UVCTerminalControlRollAbsolute, [NSNumber numberWithInt:kUVCTerminalControlEnableRollRelative],
                UVCTerminalControlRollRelative, [NSNumber numberWithInt:kUVCTerminalControlEnableFocusAuto],
                UVCTerminalControlAutoFocus, [NSNumber numberWithInt:kUVCTerminalControlEnablePrivacy],
                UVCTerminalControlPrivacy, [NSNumber numberWithInt:kUVCTerminalControlEnableFocusSimple],
                UVCTerminalControlFocusSimple, [NSNumber numberWithInt:kUVCTerminalControlEnableWindow],
                UVCTerminalControlWindow, [NSNumber numberWithInt:kUVCTerminalControlEnableRegionOfInterest],
                UVCTerminalControlRegionOfInterest, nil];
    }
...
+ (NSDictionary *)processingUnitControlEnableMapping
{
    ...
    if (!sharedProcessingUnitControlEnableMapping) {
        sharedProcessingUnitControlEnableMapping = [[NSDictionary alloc]
            initWithObjectsAndKeys:[NSNumber numberWithInt:kUVCProcessingUnitControlEnableBrightness],
                                   UVCProcessingUnitControlBrightness,
                                   [NSNumber numberWithInt:kUVCProcessingUnitControlEnableContrast],
                                   UVCProcessingUnitControlContrast,
                                   [NSNumber numberWithInt:kUVCProcessingUnitControlEnableHue],
                                   UVCProcessingUnitControlHue,
                                   [NSNumber numberWithInt:kUVCProcessingUnitControlEnableSaturation],
                                   UVCProcessingUnitControlSaturation,
                                   [NSNumber numberWithInt:kUVCProcessingUnitControlEnableSharpness],
                                   UVCProcessingUnitControlSharpness,
                                   [NSNumber numberWithInt:kUVCProcessingUnitControlEnableGamma],
                                   UVCProcessingUnitControlGamma,
                                   [NSNumber numberWithInt:kUVCProcessingUnitControlEnableWhiteBalanceTemperature],
                                   UVCProcessingUnitControlWhiteBalanceTemperature,
                                   [NSNumber numberWithInt:kUVCProcessingUnitControlEnableWhiteBalanceComponent],
                                   UVCProcessingUnitControlWhiteBalanceComponent,
                                   [NSNumber numberWithInt:kUVCProcessingUnitControlEnableBacklightCompensation],
                                   UVCProcessingUnitControlBacklightCompensation,
                                   [NSNumber numberWithInt:kUVCProcessingUnitControlEnableGain],
                                   UVCProcessingUnitControlGain,
                                   [NSNumber numberWithInt:kUVCProcessingUnitControlEnablePowerLineFrequency],
                                   UVCProcessingUnitControlPowerLineFrequency,
                                   [NSNumber numberWithInt:kUVCProcessingUnitControlEnableAutoHue],
                                   UVCProcessingUnitControlAutoHue,
                                   [NSNumber numberWithInt:kUVCProcessingUnitControlEnableAutoWhiteBalanceTemperature],
                                   UVCProcessingUnitControlAutoWhiteBalanceTemperature,
                                   [NSNumber numberWithInt:kUVCProcessingUnitControlEnableAutoWhiteBalanceComponent],
                                   UVCProcessingUnitControlAutoWhiteBalanceComponent,
                                   [NSNumber numberWithInt:kUVCProcessingUnitControlEnableDigitalMultiplier],
                                   UVCProcessingUnitControlDigitalMultiplier,
                                   [NSNumber numberWithInt:kUVCProcessingUnitControlEnableDigitalMultiplierLimit],
                                   UVCProcessingUnitControlDigitalMultiplierLimit,
                                   [NSNumber numberWithInt:kUVCProcessingUnitControlEnableAnalogVideoStandard],
                                   UVCProcessingUnitControlAnalogVideoStandard,
                                   [NSNumber numberWithInt:kUVCProcessingUnitControlEnableAnalogVideoLockStatus],
                                   UVCProcessingUnitControlAnalogLockStatus,
                                   [NSNumber numberWithInt:kUVCProcessingUnitControlEnableAutoContrast],
                                   UVCProcessingUnitControlAutoContrast, nil];
    }
...
+ (NSUInteger)controlIndexForString:(NSString *)controlString
{
    ...
    if (controlMapping) {
        ...
        if (indexObj)
            index = [indexObj unsignedIntegerValue];
    }
    return index;
}
- (NSUInteger)controlIndexForString:(NSString *)controlString
    ...
    if (controlIndex != UVCInvalidControlIndex) {
        switch (UVCControllerControls[controlIndex].unitType) {
            ...
            case UVC_PROCESSING_UNIT_ID: {
                ...
                // descriptor, don't prevent the code from TRYING to access the
                // control and failing:
                if (!_processingUnitControlsAvailable)
                    return NO;
                // Get the bit index for the given control:
         ...
         ioServiceObject:(io_service_t)ioServiceObject
{
    if ((self = [self init])) {
        ...
        _unitIds = [[NSMutableDictionary alloc]
            initWithObjectsAndKeys:[NSNumber numberWithInt:UVC_INPUT_TERMINAL_ID], @"UVC_INPUT_TERMINAL_ID",
                                   [NSNumber numberWithInt:UVC_PROCESSING_UNIT_ID], @"UVC_PROCESSING_UNIT_ID", nil];
...
- (BOOL)findControllerInterfaceForServiceObject:(io_service_t)ioServiceObject
{
    ...
    SInt32 score;
    kern_return_t krc = IOCreatePlugInInterfaceForService(ioServiceObject, kIOUSBDeviceUserClientTypeID,
    ...
    IOReturn hrc =
        (*plugInInterface)
            ->QueryInterface(plugInInterface, CFUUIDGetUUIDBytes(kIOUSBDeviceInterfaceID), (LPVOID *) &deviceInterface);
    ...
    krc = IOCreatePlugInInterfaceForService(usbInterface, kIOUSBInterfaceUserClientTypeID, kIOCFPlugInInterfaceID,
    ...
    if ((interfaceDescriptor =
             (*_controllerInterface)->FindNextAssociatedDescriptor(_controllerInterface, NULL, CS_INTERFACE))) {
        //
        ...
        switch (descriptorPrefix->bDescriptorSubType) {
            case VC_HEADER: {
                UVC_VC_Interface_Header_Descriptor *vcHeader =
                    (UVC_VC_Interface_Header_Descriptor *) interfaceDescriptor;
                    ...
                    if (descriptorPrefix->bDescriptorType == CS_INTERFACE) {
                        switch (descriptorPrefix->bDescriptorSubType) {
                            case VC_INPUT_TERMINAL: {
                                UVC_VC_Terminal_Header_Descriptor *terminalHeader =
                                    (UVC_VC_Terminal_Header_Descriptor *) basePtr;

                                if (terminalHeader->bControlSize > 0) {
                                    _terminalControlsAvailable = [[NSData alloc]
                                        initWithBytes:&terminalHeader->bmControls[0]
                                               length:terminalHeader->bControlSize];
                                }
                                break;
                            }
                            ...
                            case VC_PROCESSING_UNIT: {
                                ...
                                if (puHeader->bControlSize > 0) {
                                    [_unitIds setObject:[NSNumber numberWithInt:puHeader->bUnitId]
                                                 forKey:@"UVC_PROCESSING_UNIT_ID"];
                                    _processingUnitControlsAvailable = [[NSData alloc]
                                        initWithBytes:&puHeader->bmControls[0]
                                               length:puHeader->bControlSize];
                                }
                                break;
                            }
                        }
...
- (BOOL)setData:(void *)value withLength:(int)length forSelector:(int)selector atUnitId:(int)unitId
{
    IOUSBDevRequest controlRequest = {.bmRequestType = USBmakebmRequestType(kUSBOut, kUSBClass, kUSBInterface),
...
- (BOOL)getData:(void *)value ofType:(int)type withLength:(int)length fromSelector:(int)selector atUnitId:(int)unitId
{
    IOUSBDevRequest controlRequest = {.bmRequestType = USBmakebmRequestType(kUSBIn, kUSBClass, kUSBInterface),
                                      .bRequest = type,
                                      .wValue = (selector << 8),
                                      .wIndex = (unitId << 8) | _videoInterfaceIndex,
                                      .wLength = length,
...
- (BOOL)capabilities:(NSUInteger *)capabilities forControl:(NSUInteger)controlId
{
    uvc_control_t *control = &UVCControllerControls[controlId];
    uint8_t scratch;

    if ([self getData:&scratch ofType:UVC_GET_INFO withLength:1 fromSelector:control->selector
                atUnitId:[[_unitIds objectForKey:control->unitTypeStr] intValue]]) {
                   ...
                   forControl:(NSUInteger)controlId
{
    ...
    if (*lowValue && *highValue) {
        if ([self getData:[*lowValue valuePtr] ofType:UVC_GET_MIN withLength:(int) [*lowValue byteSize]
                fromSelector:control->selector
                    atUnitId:unitId] &&
            [self getData:[*highValue valuePtr] ofType:UVC_GET_MAX withLength:(int) [*highValue byteSize]
                fromSelector:control->selector
                    atUnitId:unitId]) {
    ...
    if (*stepSize) {
        if ([self getData:[*stepSize valuePtr] ofType:UVC_GET_RES withLength:(int) [*stepSize byteSize]
                fromSelector:control->selector
                    atUnitId:unitId]) {
    ...
    if (*defaultValue) {
        if ([self getData:[*defaultValue valuePtr] ofType:UVC_GET_DEF withLength:(int) [*defaultValue byteSize]
                fromSelector:control->selector
                    atUnitId:unitId]) {
...
- (BOOL)getValue:(UVCValue *)value forControl:(NSUInteger)controlId
{
    ...
    if ([self getData:[value valuePtr] ofType:UVC_GET_CUR withLength:(int) [value byteSize]
            fromSelector:control->selector
                atUnitId:[[_unitIds objectForKey:control->unitTypeStr] intValue]]) {
...
- (BOOL)setValue:(UVCValue *)value forControl:(NSUInteger)controlId
{
    ...
    rc = [self setData:[value valuePtr] withLength:(int) [value byteSize] forSelector:control->selector
              atUnitId:[[_unitIds objectForKey:control->unitTypeStr] intValue]];
    [value byteSwapUSBToHostEndian];
    return rc;
}
...
+ (NSArray *)controlStrings
{
    ...
    if (!sharedControlStrings) {
        ...
        if (controlMapping)
            sharedControlStrings = [controlMapping allKeys];
    }
...
+ (NSArray *)uvcControllers
{
    ...
    if (IOServiceGetMatchingServices(kIOMainPortDefault, matchingDict, &deviceIter) == KERN_SUCCESS) {
        ...
        while ((device = IOIteratorNext(deviceIter))) {
            ...
            if (newController) {
                if (!newControllers)
                    newControllers = [[NSMutableArray alloc] init];
...
{
    CFNumberRef vendorIdObj =
        IORegistryEntrySearchCFProperty(ioService, kIOUSBPlane, CFSTR(kUSBVendorID), kCFAllocatorDefault, 0);
    CFNumberRef productIdObj =
        IORegistryEntrySearchCFProperty(ioService, kIOUSBPlane, CFSTR(kUSBProductID), kCFAllocatorDefault, 0);
    CFNumberRef locationIdObj = IORegistryEntrySearchCFProperty(
        ioService, kIOUSBPlane, CFSTR(kUSBDevicePropertyLocationID), kCFAllocatorDefault, 0);
    ...
    return [[[UVCController alloc] initWithLocationId:locationId vendorId:vendorId productId:productId
                                      ioServiceObject:ioService] autorelease];
}
...
+ (id)uvcControllerWithLocationId:(UInt32)locationId
{
    ...
    // Find a USB Device with the given locationId:
    CFMutableDictionaryRef matchingDict = IOServiceMatching(kIOUSBDeviceClassName);
    CFMutableDictionaryRef propertiesDict = CFDictionaryCreateMutable(
    ...
    if (device) {
        CFNumberRef vendorIdObj =
            IORegistryEntrySearchCFProperty(device, kIOUSBPlane, CFSTR(kUSBVendorID), kCFAllocatorDefault, 0);
        CFNumberRef productIdObj =
            IORegistryEntrySearchCFProperty(device, kIOUSBPlane, CFSTR(kUSBProductID), kCFAllocatorDefault, 0);
        UInt16 vendorId = -1, productId = -1;
        ...
        newController = [[[UVCController alloc] initWithLocationId:locationId vendorId:vendorId productId:productId
                                                   ioServiceObject:device] autorelease];
    }
...
+ (id)uvcControllerWithVendorId:(UInt16)vendorId productId:(UInt16)productId
{
    ...
    if (device) {
        CFNumberRef locationIdObj = IORegistryEntrySearchCFProperty(
            device, kIOUSBPlane, CFSTR(kUSBDevicePropertyLocationID), kCFAllocatorDefault, 0);
        UInt32 locationId = -1;
...
- (void)dealloc
{
    ...
    if (_processingUnitControlsAvailable)
        [_processingUnitControlsAvailable release];
    if (_controls)
        [_controls release];
    if (_unitIds)
        [_unitIds release];
...
- (NSString *)description
{
    return [NSString
        stringWithFormat:
            @"UVCController@%p { \"%@\"; vendor-id=0x%04x; product-id=0x%04x; location-id=0x%08x; uvc-version: 0x%04x interface-index: %d%s }",
            self, _deviceName, _vendorId, _productId, _locationId, _uvcVersion, _videoInterfaceIndex,
...
- (void)setIsInterfaceOpen:(BOOL)isInterfaceOpen
{
    if (isInterfaceOpen != _isInterfaceOpen) {
        ...
        if (isInterfaceOpen) {
            ...
            if (rc == kIOReturnSuccess)
                _shouldNotCloseInterface = _isInterfaceOpen = NO;
        }
    }
}
...
- (UVCControl *)controlWithName:(NSString *)controlName
{
    ...
    if (!theControl) {
        if (![self controlIsNotAvailable:controlName]) {
            ...
            if (controlIndex != UVCInvalidControlIndex) {
                theControl = [[UVCControl alloc] initControlWithName:controlName parentController:self
    ...
    if ([theControl isMemberOfClass:[NSNull class]])
        return nil;
    return theControl;
}
             ...
             controlIndex:(NSUInteger)controlIndex
{
    if ((self = [super init])) {
        if (![parentController capabilities:&_capabilities forControl:controlIndex]) {
            ...
            [_parentController getLowValue:&_minimum highValue:&_maximum stepSize:&_stepSize defaultValue:&_defaultValue
                 updateCapabilitiesBitmask:&_capabilities
                                forControl:controlIndex];
        }
    }
    return self;
}
...
- (NSString *)description
{
    NSMutableString *outString = [[NSMutableString alloc]
        initWithFormat:@"UVCControl[%@]@%p { capabilities: %012x, byte-size: %lu", _controlName, self,
                       (unsigned int) _capabilities, (unsigned long) [_currentValue byteSize]];
...
{
    if ([self hasDefaultValue])
        return [_parentController setValue:_defaultValue forControl:_controlIndex];
    return NO;
}
...
{
    return [_currentValue scanCString:cString flags:flags minimum:_minimum maximum:_maximum stepSize:_stepSize
...
- (NSString *)summaryString
{
    NSMutableString *asString = [[NSMutableString alloc] initWithFormat:@"%@ {\n  type-description: {\n%@  },",
                                                                        _controlName,
                                                                        [[_currentValue valueType] typeSummaryString]];
    if ([self hasRange]) {
...
- (NSDictionary *)summaryDictionary
{
    ...
    [dict setObject:_controlName forKey:@"name"];
    [dict setObject:[[_currentValue valueType] typeSummaryDictionary] forKey:@"type-description"];

    if ([self hasRange]) {
        if (_minimum)
            [dict setObject:[_minimum jsonObject] forKey:@"minimum"];
        if (_maximum)
            [dict setObject:[_maximum jsonObject] forKey:@"maximum"];
    }
    if ([self hasStepSize]) {
        if (_stepSize)
            [dict setObject:[_stepSize jsonObject] forKey:@"step-size"];
    }
    if ([self hasDefaultValue]) {
        if (_defaultValue)
            [dict setObject:[_defaultValue jsonObject] forKey:@"default-value"];
    }

    UVCValue *curValue = [self currentValue];
    if (curValue)
        [dict setObject:[curValue jsonObject] forKey:@"current-value"];
